...
MEDIA_IMAGES = os.path.join( WEB_ROOT, 'media',  'images')
MEDIA_SCRIPTS = os.path.join( WEB_ROOT, 'media',  'scripts')
MEDIA_CSS = os.path.join( WEB_ROOT, 'media',  'css')
...
SECRET_KEY = 'v^5b3-5_#32et%&amp;=(bv%8-yayqllq=%t$bpf3s#7pc%&amp;6xsr29'
