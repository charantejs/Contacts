...
(function($) {
    ...
    var methods = {
            ...
            for (var i = 0; i < rules.length; i++) {
                ...
                switch (rules[i]) {
                    ...
                    case "equals":
                        ...
                        break;
                    case "lessThanEquals":
                        errorMsg = methods._lessThanEquals(field, rules, i, options);
                        break;
                    case "funcCall":
         ...
         * @return an error string if validation failed
         */
        _lessThanEquals: function(field, rules, i, options) {
            var lessThanEqualsField = rules[i + 1];

            if (parseFloat(field.attr('value')) > parseFloat($("#" + lessThanEqualsField).attr('value')))
                return options.allrules.lessThanEquals.alertText + rules[i + 2];
        },
